...
const COMPLETE_REGS_DICT	= {A_STATUS:A_STATUS,A_INT_SOURCE:A_INT_SOURCE,I2C_AM_ADDRESS:I2C_AM_ADDRESS,I2C_G_ADDRESS:I2C_G_ADDRESS,A_XYZ_DATA_CFG:A_XYZ_DATA_CFG,A_TRIG_CFG:A_TRIG_CFG,A_CTRL_REG1:A_CTRL_REG1,A_CTRL_REG2:A_CTRL_REG2,A_CTRL_REG3:A_CTRL_REG3,A_CTRL_REG4:A_CTRL_REG4,A_CTRL_REG5:A_CTRL_REG5,
                       A_ASPL_COUNT:A_ASPL_COUNT,A_TEMP:A_TEMP,
                       A_OUT_X_MSB:A_OUT_X_MSB,A_OUT_X_LSB:A_OUT_X_LSB,A_OUT_Y_MSB:A_OUT_Y_MSB,A_OUT_Y_LSB:A_OUT_Y_LSB,A_OUT_Z_MSB:A_OUT_Z_MSB,A_OUT_Z_LSB:A_OUT_Z_LSB,
                       A_F_SETUP:A_F_SETUP,A_XYZ_DATA_CFG:A_XYZ_DATA_CFG,A_HP_FILTER_CUTOFF:A_HP_FILTER_CUTOFF,A_PL_CFG:A_PL_CFG,
			              ...
			              A_OFF_X:A_OFF_X,A_OFF_Y:A_OFF_Y,A_OFF_Z:A_OFF_Z,
			              M_OUT_X_MSB:M_OUT_X_MSB,M_OUT_X_LSB:M_OUT_X_LSB,M_OUT_Y_MSB:M_OUT_Y_MSB,M_OUT_Y_LSB:M_OUT_Y_LSB,M_OUT_Z_MSB:M_OUT_Z_MSB,M_OUT_Z_LSB:M_OUT_Z_LSB,
			              M_OFF_X_MSB:M_OFF_X_MSB,M_OFF_X_LSB:M_OFF_X_LSB,M_OFF_Y_MSB:M_OFF_Y_MSB,M_OFF_Y_LSB:M_OFF_Y_LSB,
			              ...
			              G_OUT_X_MSB:G_OUT_X_MSB,G_OUT_X_LSB:G_OUT_X_LSB,G_OUT_Y_MSB:G_OUT_Y_MSB,G_OUT_Y_LSB:G_OUT_Y_LSB,G_OUT_Z_MSB:G_OUT_Z_MSB,G_OUT_Z_LSB:G_OUT_Z_LSB};
...
const M_CREGS_LIST =  ['M_OFF_X_MSB','M_OFF_X_LSB','M_OFF_Y_MSB','M_OFF_Y_LSB','M_OFF_Z_MSB','M_OFF_Z_LSB','M_THS_CFG','M_THS_COUNT',
			    'M_CTRL_REG1','M_CTRL_REG2','M_CTRL_REG3','M_VECM_CFG','M_VECM_THS_MSB','M_VECM_THS_LSB','M_VECM_CNT'];

const G_CREGS_LIST =  ['G_F_SETUP','G_CTRL_REG0','G_RT_CFG','G_RT_THS','G_RT_COUNT','G_CTRL_REG1','G_CTRL_REG2','G_CTRL_REG3'];

module.exports = {COMPLETE_REGS_DICT,A_CREGS_LIST,M_CREGS_LIST,G_CREGS_LIST};