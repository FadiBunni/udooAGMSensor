...
const G_WHO_AM_I			= 0x0c # contains the device identifier which is factory programmed to 0xD7 
...
var COMPLETE_REGS_DICT	= {'A_TRIG_CFG':A_TRIG_CFG,'A_CTRL_REG1':A_CTRL_REG1,'A_CTRL_REG2':A_CTRL_REG2,'A_CTRL_REG3':A_CTRL_REG3,'A_CTRL_REG4':A_CTRL_REG4,'A_CTRL_REG5':A_CTRL_REG5,
...
var A_CREGS_LIST = ['A_TRIG_CFG','A_CTRL_REG1','A_CTRL_REG2','A_CTRL_REG3','A_CTRL_REG4','A_CTRL_REG5','A_ASPL_COUNT','A_F_SETUP','A_XYZ_DATA_CFG','A_HP_FILTER_CUTOFF','A_PL_CFG',
...
var M_CREG_LIST =  ['M_OFF_X_MSB','M_OFF_X_LSB','M_OFF_Y_MSB','M_OFF_Y_LSB','M_OFF_Z_MSB','M_OFF_Z_LSB','M_THS_CFG','M_THS_COUNT',
			    'M_CTRL_REG1','M_CTRL_REG2','M_CTRL_REG3','M_VECM_CFG','M_VECM_THS_MSB','M_VECM_THS_LSB','M_VECM_CNT']
var G_CREG_LIST =  ['G_F_SETUP','G_CTRL_REG0','G_RT_CFG','G_RT_THS','G_RT_COUNT','G_CTRL_REG1','G_CTRL_REG2','G_CTRL_REG3']